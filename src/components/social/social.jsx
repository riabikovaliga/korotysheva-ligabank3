        ...
        <ul className={`${className} social`}>
            <li className="social__item">
                <a className="social__link social__link--facebook" href="/">
                    ...
                    <svg className="social__link-icon" width="9" height="16" viewBox="0 0 9 16" fill="none"
            ...
            <li className="social__item">
                <a className="social__link social__link--instagram" href="/">
                    ...
                    <svg className="social__link-icon" width="16" height="16" viewBox="0 0 16 16" fill="none"
                         xmlns="http://www.w3.org/2000/svg">
                        <path
            ...
            <li className="social__item">
                <a className="social__link social__link--twitter" href="/">
                    ...
                    <svg className="social__link-icon" width="16" height="13" viewBox="0 0 16 13" fill="none"
                         xmlns="http://www.w3.org/2000/svg">
                        <path
